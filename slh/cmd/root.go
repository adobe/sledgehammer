...
Use dockerized tools like they are installed on the  system.`,
	...
	rootCommand.PersistentPreRunE = func(cmd *cobra.Command, args []string) error {
		initializeLogger(cfg, logLevel, cfg.OutputType == "json")
	...
	rootCommand.PersistentFlags().StringVarP(&cfg.OutputType, "output", "o", "text", "Define the output, currently supported is table|json")
...
func initializeLogger(cfg *config.Config, logLevel string, JSON bool) {
	//  init logrus
